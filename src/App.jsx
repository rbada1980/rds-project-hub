    ...
    {dashStatModal&&(()=>{
      ...
      if(!lastDrill){
        ...
        if(DSM==="users"){
          ...
          items=teamMembers.map(name=>({label:name,sub:`${tasks.filter(t=>t.assignee===name&&t.status==="In Progress").length} in progress · ${tasks.filter(t=>t.assignee===name&&isDone(t.status)).length} done`,do