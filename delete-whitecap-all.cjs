// delete-whitecap-all.cjs
// Deletes ALL White Cap tasks and projects from Supabase + local PostgreSQL
// Run: node delete-whitecap-all.cjs
...
async function main(){
  console.log("🗑  Deleting ALL White Cap data...\n");

  // 1. Get all White Cap project IDs
  ...
  console.log(`📋 Found ${projects.length} White Cap projects`);
