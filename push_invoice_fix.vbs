...
' Git commit and push
oShell.Run "cmd /c cd /d C:\Users\HP\rds-project-hub && git add src/App.jsx && git commit -m ""feat: invoice draft - edit pencil, re-download PDF, edit modal"" && git push origin main >> build_invoice_result.txt 2>&1", 1, True
